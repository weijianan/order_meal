...
<body class="">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<ul class="nav pull-right">
				...
				<li id="fat-menu" class="dropdown"><a href="#" role="button"
					class="dropdown-toggle" data-toggle="dropdown"> <i
						class="icon-user"></i>${login_user.username} <i
			...
			<a class="brand" href="<%=basePath%>index.jsp"><span
	...
	<div class="content">
		...
		<ul class="breadcrumb">
			<li><a href="<%=basePath%>home.do?flag=home">主页</a> <span
				class="divider">/</span></li>
			<li class="active">菜谱</li>
		</ul>

		<div class="container-fluid">
			<a href="menu?flag=menuAdd">添加</a>
			<div class="row-fluid">
				<div class="row-fluid">
					...
					<ul class="thumbnails">
						<div class="row-fluid">
							<c:forEach items="${menulist}" var="menu" begin="0" end="3">
								...
								<li class="span3">
									<div class="thumbnail">
										<img src="<%=basePath %>images/${menu.pic}" alt="" width="220"
											height="170">
										<h3>${menu.name}</h3>
										<a href="<%=basePath %>menu?flag=menuPre&id=${menu.id}"
											class="btn btn-primary"> 预 览</a> <a class="btn btn-info"
											href="<%=basePath %>menu?flag=menuEdit&id=${menu.id}"> <i
								...
								<li class="span3">
									<div class="thumbnail">
										<img src="<%=basePath %>images/${menu.pic}" alt="" width="220"
											height="170">
										<h3>${menu.name}</h3>
										<a href="#" class="btn btn-primary"> 预 览</a> <a
											class="btn btn-info"
											href="<%=basePath %>menu?flag=menuEdit&id=${menu.id}"> <i
											class="icon-edit icon-white"></i>修改
										</a>
				...
				<div class="pagination">
					<div align="right">
						<ul>
							<c:if test="${pre=='yes'}">
								<li><a
									href="<%=basePath %>menu?flag=menu&pageNow=${pNow-1}">前一页</a></li>
							</c:if>
							<c:forEach var="i" begin="1" end="${pageCount}">
								<li><a href="<%=basePath %>menu?flag=menu&pageNow=${i }">${i }</a>
								</li>
							</c:forEach>
							<c:if test="${next=='yes'}">
								<li><a
									href="<%=basePath %>menu?flag=menu&pageNow=${pNow+1}">后一页</a></li>
							</c:if>
						</ul>
					</div>
				</div>
