...
<div class="content">
        ...
        <div class="container-fluid">
            ...
            <form action="<%=basePath %>menu.do?flag=updMenu" method="post" class="form-horizontal"  enctype="multipart/form-data" >    
            <div class="row-fluid">
               <div class="span7">  	
               <input name="id"  id="name" type="hidden" value="${menu.id}">
				...
				<div class="span5">
					<div class="fileupload fileupload-new" data-provides="fileupload">
					  <div class="fileupload-new thumbnail" style="width: 220px; height: 170px;"><img src="<%=basePath %>images/${menu.pic}" /></div>
					  ...
					  <input type="file" name="photo" value="<%=basePath %>images/${menu.pic}" />
					  </span>
