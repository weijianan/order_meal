 ...
 <div class="content">
        ...
        <!-- 提示框1 -->
       	 ...
       	 <!-- 提示框2 -->
					  ...
					  <div  class="modal-body">
					  <form action="<%=basePath %>table.do?flag=addTable" method="post">
        ...
        <div class="header">
            ...
            <h1 class="page-title">餐桌</h1>
                ...
                <ul class="breadcrumb">
            <li><a href="<%=basePath %>table.do?flag=table">餐桌</a> <span class="divider">/</span></li>
    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable">
      ...
      <c:forEach items="${tablelist}" var="tbl">
        <tr>
          ...
          <td>
              <a  class="btn btn-info" href="<%=basePath %>TableEdit?id=${tbl.id}"><i class="icon-edit icon-white"></i>修改</a>
...
<div class="pagination">
    <ul>
    	<c:if test="${pre=='yes'}">
        <li><a href="<%=basePath %>table.do?flag=table&pageNow=${pNow-1}">前一页</a></li>
    	</c:if>
        <c:forEach var="i" begin="1" end="${pageCount}">
        <li>
        <a href="<%=basePath %>table.do?flag=table&pageNow=${i }">${i }</a>
        </li>
        </c:forEach>
        <c:if test="${next=='yes'}">
        <li><a href="<%=basePath %>table.do?flag=table&pageNow=${pNow+1}">后一页</a></li>
        </c:if>
    </ul>
</div>             
                  <footer>
...
$(document).ready(function(){
  ...
  */
	...
	var url="<%=basePath %>TableServlet?tid="+$(this).attr('id');
...
function del(obj){
	...
	var delurl="<%=basePath %>table.do?flag=delTable&delid="+delid+"&pageNow="+pNow;
	$("#myModal").modal("show").on("shown", function () {
		$("#delbtn2").attr('href',delurl);
	});
}
